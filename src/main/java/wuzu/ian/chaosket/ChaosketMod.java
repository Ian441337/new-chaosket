...
import wuzu.ian.chaosket.init.ChaosketModPotions;
...
@Mod("chaosket")
public class ChaosketMod {
	public static final Logger LOGGER = LogManager.getLogger(ChaosketMod.class);
	public static final String MODID = "chaosket";
	...
	public ChaosketMod() {
		...
		ChaosketModMobEffects.REGISTRY.register(bus);
		ChaosketModPotions.REGISTRY.register(bus);
						...
						for (Field field : fields) {
							if (EditBox.class.isAssignableFrom(field.getType())) {
								try {
									...
									ChaosketMod.LOGGER.error(exceptionAsString);
								}
							}
						}
					}
	...
	public static class initer {
		...
		public static void init(FMLCommonSetupEvent event) {
			ChaosketMod.addNetworkMessage(TextboxSetMessage.class, TextboxSetMessage::buffer, TextboxSetMessage::new, TextboxSetMessage::handler);
		}
	}
